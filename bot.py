...
async def addrole(ctx, role: discord.Role, member: discord.Member=None):
    ...
    await send_message(826967699082969088,f'{member.name} повышен до {role},Kebabobka HQ поздравляет вас!')
@client.command() 
async def ping(ctx):
    await ctx.send('pong')
...
async def on_message(message):
    if message.author == client.user:
        return
    if 'секс' in message.content or 'поебемся' in message.content or 'ебаться' in message.content or 'хорни' in message.content or 'трахаться' in message.content or 'выебу' in message.content or 'виебу' in message.content or 'трахну' in message.content or 'сиськи' in message.content or 'попу' in message.content or 'попа' in message.content or 'анал' in message.content  or 'ебля' in message.content or 'оргия' in message.content or 'свингер пати' in message.content or 'порно' in message.content or  'прон' in message.content or 'хентай' in message.content or 'нюдс' in message.content or 'нюдсы' in message.content  or 'сиси' in message.content or 'пися' in message.content or 'вагина' in message.content or 'ваджайна' in message.content or 'пизда' in message.content or 'ебаца' in message.content or 'ебатися' in message.content or 'стояк' in message.content or 'потекла' in message.content or 'теку' in message.content or 'смазка' in message.content or 'презерватив' in message.content or 'оргазм' in message.content or 'кончил' in message.content or 'сперма' in message.content or 'конча' in message.content or 'анус' in message.content or 'вуайерист' in message.content or 'куколд' in message.content or 'фурри' in message.content or 'чайный пакетик' in message.content or 'вульва' in message.content or 'клитор' in message.content or 'мошонка' in message.content or 'футфетиш' in message.content or 'фетиш' in message.content or 'ножки' in message.content or 'сосочки' in message.content or 'кок' in message.content:
        await message.channel.send('<:booba:839869013064548383>')
    if 'Подруб' in message.content or'подруб' in message.content  or'во сколько' in message.content or'Во сколько' in message.content or'в какое время' in message.content or'В какое время' in message.content  or'стримить' in message.content or'Стримить' in message.content or'след стрим' in message.content or'как часто подрубаешь' in message.content or'Как часто подрубаешь' in message.content or'подрубать' in message.content or'Подрубать' in message.content or'запуск' in message.content or'Запуск' in message.content or'запускаешь' in message.content or'Запускаешь' in message.content:
